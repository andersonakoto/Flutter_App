...
class NotConnectedProfile extends StatefulWidget {
  @override
  _NotConnectedProfileState createState() => _NotConnectedProfileState();
}

class _NotConnectedProfileState extends State<NotConnectedProfile> {
  @override
  Widget build(BuildContext context) {
    ...
    Widget sub_container = Container(
        ...
        child: Column(children: [
          ...
          Container(
              margin: EdgeInsets.only(
                  left: 20.0, top: 60.0, right: 0.0, bottom: 40.0),
              width: 150,
              alignment: Alignment.center,
