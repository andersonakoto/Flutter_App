    ...
    return MaterialApp(
        ...
        home:Scaffold(
            ...
            body: SingleChildScrollView(
              ...
              Container(
                margin: EdgeInsets.only(left:30.0, top:0.0, right: 30.0, bottom: 5.0),
                child: TextField(
                 ...
                 Container(
                     margin: EdgeInsets.only(left: 0.0, top: 0.0, right: 10.0, bottom:10.0),
                 ...
                 Container(
                     margin: EdgeInsets.only(left: 30.0, top: 20.0, right: 30.0, bottom: 30.0),
                     width: 800,
                     alignment: Alignment.center,
                 ...
                 Container(
                   ...
                   children: <Widget> [
                     Expanded(
                       child : Divider(endIndent: 10, color: Colors.grey, thickness: 1.5,),
                     ),
                     Text('or', style: TextStyle(fontSize: 20, color: Colors.grey[800]),),
                     Expanded(
                       child : Divider(indent: 10, color: Colors.grey, thickness: 1.5,),
                     ),
                   ],
                 ),
                 ),
